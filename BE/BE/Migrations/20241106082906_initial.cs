        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfSessions = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextAppointmentDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AppointmentId = table.Column<int>(type: "integer", nullable: false),
                    AppointmentRating = table.Column<int>(type: "integer", nullable: false),
                    AppointmentComment = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new TimeOnly(9, 30, 0), "Ca 1", new TimeOnly(7, 30, 0) },
                    { 2, new TimeOnly(12, 0, 0), "Ca 2", new TimeOnly(10, 0, 0) },
                    { 3, new TimeOnly(15, 0, 0), "Ca 3", new TimeOnly(13, 0, 0) },
                    { 4, new TimeOnly(17, 30, 0), "Ca 4", new TimeOnly(15, 30, 0) },
                    { 5, new TimeOnly(20, 0, 0), "Ca 5", new TimeOnly(18, 0, 0) }
                });
