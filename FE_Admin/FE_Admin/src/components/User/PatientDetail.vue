<template>
    ...
    <div class="relative p-4 overflow-x-auto shadow-md sm:rounded-lg">
        <h3 class="text-2xl font-extrabold dark:text-white">Thông tin khách hàng</h3>
        <br />
        <form @submit.prevent="updatePatient">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="fullname" v-model="patient.fullname" :disabled="!isEditing"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="dob" type="date" v-model="patient.doB" :disabled="!isEditing"
                ...
                <div>
                    ...
                    <input type="email" id="email" v-model="patient.email" disabled
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="tel" id="phone" v-model="patient.phoneNumber" :disabled="!isEditing"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="text" id="address" v-model="patient.address" :disabled="!isEditing"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div v-if="isAdmin">
                ...
                <router-link to="/patient" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Quay
                    lại</router-link>
            </div>
            <div v-else>
                <router-link to="/schedule" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Quay
                    lại</router-link>
            </div>       
        </form>
    </div>
    <UserRecord :patientId="patientId"/>
...
export default {
    ...
    methods: {
        async fetchPatient() {
            ...
            try {
                const response = await fetch(`https://localhost:7072/api/user/${this.patientId}`);
        ...
        async updatePatient() {
            try {
                ...
                const patientToUpdate = {
                    ...this.patient,
                    doB: this.formatDateForSubmission(this.patient.doB),
                    password: "password"
                };

                const response = await fetch(`https://localhost:7072/api/user/${this.patient.id}`, {
                    method: 'PUT',
                    headers: {
        ...
        async confirmDelete() {
            ...
            try {
                const response = await fetch(`https://localhost:7072/api/user/${patientId}`, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
                    }
