    ...
    methods: {
        async fetchAppointments() {
            ...
            try {
                ...
                const response = await axios.get('https://localhost:7072/api/appointment/weekly-staff', {
                    params: { 
                        startDate: this.startDate,
                        staffId: localStorage.getItem("idStaff")
                     },
                });
                this.weeklyAppointments = response.data;
                console.log(this.weeklyAppointments);
...
<template>
    <div class="relative p-4 overflow-x-auto shadow-md sm:rounded-lg">
        <h3 class="text-2xl font-extrabold dark:text-white">Lịch hẹn trong tuần</h3>
                ...
                <div class="flex">
                    ...
                    <div class="flex items-center me-4">
                        ...
                        <label for="inline-checked-checkbox"
                            class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Đã hoàn thành</label>
                    </div>
                        ...
                        <td v-for="day in weeklyAppointments" :key="day.date"
                            ...
                            'bg-red-100 text-red-800': appointment.status === 'Cancelled'
                                    ...
                                    <p class="font-semibold text-xs">
                                        Nhân viên: {{ appointment.staffFullName}}</p>
