                ...
                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel"
                    ...
                    <dl
                        ...
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalPatients }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Bệnh nhân</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalStaffs }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Nhân viên</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalServices }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Dịch vụ</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalServicePackages }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Gói dịch vụ</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalSubscription }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Lượt sử dụng</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl font-extrabold">{{ this.statsData.totalAppointments }}</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Lịch hẹn</dd>
                        </div>
                    </dl>
                </div>
                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel"
                    aria-labelledby="about-tab">
                    <h2 class="mb-5 text-2xl font-extrabold text-gray-900 dark:text-white">Homecare Service Cung cấp
                        dịch vụ chăm sóc sức khỏe tận tâm tại nhà</h2>
                    <!-- List -->
                    <ul role="list" class="space-y-4 text-gray-500 dark:text-gray-400">
                        <li class="flex space-x-2 rtl:space-x-reverse items-center">
                            ...
                            <span class="leading-tight">Tận dụng đội ngũ y tế chuyên nghiệp để mang lại sự chăm sóc và điều trị tốt nhất cho bạn ngay tại nhà</span>
                        </li>
                        <li class="flex space-x-2 rtl:space-x-reverse items-center">
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="leading-tight">Cung cấp những báo cáo sức khỏe và tiến độ hồi phục thông qua các liệu trình vật lý trị liệu cá nhân hóa.</span>
                        </li>
                        <li class="flex space-x-2 rtl:space-x-reverse items-center">
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="leading-tight">Các gói chăm sóc sau phẫu thuật phù hợp với từng bệnh nhân, mang lại sự hồi phục an toàn và hiệu quả.</span>
                        </li>
                        <li class="flex space-x-2 rtl:space-x-reverse items-center">
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="leading-tight">Theo dõi và chăm sóc sức khỏe thường xuyên giúp phát hiện sớm và ngăn ngừa bệnh lý tiềm ẩn.</span>
                        </li>
                    </ul>
                </div>
...
export default {
    ...
    methods: {
        async fetchData() {
            try {
                const response = await axios.get('https://localhost:7072/api/stats');
